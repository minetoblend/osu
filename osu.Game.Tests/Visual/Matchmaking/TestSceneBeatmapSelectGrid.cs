    ...
    public partial class TestSceneBeatmapSelectGrid : OnlinePlayTestScene
    {
        ...
        public void TestCompleteRollAnimation()
        {
            AddStep("play animation", () =>
            {
                ...
                grid.RollAndDisplayFinalBeatmap(candidateItems, finalItem, MatchmakingRoomState.RolledPanelType.Beatmap);
            });
        }
        ...
        public void TestPresentRolledBeatmap()
        {
            AddStep("present beatmap", () =>
            {
                ...
                Scheduler.AddDelayed(() => grid.PresentRolledBeatmap(finalItem, MatchmakingRoomState.RolledPanelType.Beatmap), 500);
            });
        }
        ...
        public void TestPresentUnanimouslyChosenBeatmap()
        {
            AddStep("present beatmap", () =>
            {
                ...
                Scheduler.AddDelayed(() => grid.PresentUnanimouslyChosenBeatmap(finalItem, MatchmakingRoomState.RolledPanelType.Beatmap), 500);
            });
        }
        ...
        public void TestPresentRandomItem()
        {
            AddStep("present random item panel", () =>
            {
                ...
                {
                    grid.PresentRolledBeatmap(finalItem, MatchmakingRoomState.RolledPanelType.Random);
