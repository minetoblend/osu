...
namespace osu.Game.Rulesets.Osu.Edit.Blueprints.Streams
{
    ...
    {
        public new Objects.StreamHitObject HitObject => (Objects.StreamHitObject)base.HitObject;
        ...
        private Container<HitCirclePiece> circlePieces;
        ...
        private void load(OsuColour colours)
        {
            ...
            {
                circlePieces = new Container<HitCirclePiece>(),
        ...
        private void updateStream()
        {
            ...
            //HitObject.DurationPerCircle = composer?.GetBeatSnapDistanceAt(HitObject) ?? HitObject.DurationPerCircle;
            HitObject.UpdateNestedHitObjects();

            circlePieces.Clear();

            foreach (var hitCircle in HitObject.NestedHitObjects.OfType<HitCircle>())
            {
                var piece = new HitCirclePiece();
                piece.UpdateFrom(hitCircle);
                circlePieces.Add(piece);
            }
        }
