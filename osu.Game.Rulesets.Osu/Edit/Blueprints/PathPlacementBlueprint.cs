...
{
    public class PathPlacementBlueprint : PlacementBlueprint
    {
        public new Objects.HitObjectWithPath HitObject => (Objects.HitObjectWithPath)base.HitObject;

        private PathControlPoint segmentStart;
        private PathControlPoint cursor;
        private int currentSegmentLength;

        protected PathPlacementState State;
        ...
        public PathPlacementBlueprint(HitObjectWithPath hitObject)
            : base(hitObject)
        {
        ...
        public override void UpdateTimeAndPosition(SnapResult result)
        {
            ...
            switch (State)
            {
                case PathPlacementState.Initial:
                    BeginPlacement();
        ...
        {
            if (State == PathPlacementState.Body && e.Button == MouseButton.Right)
                endCurve();
            base.OnMouseUp(e);
        }
        ...
        private void beginCurve()
        {
            ...
            SetState(PathPlacementState.Body);
        }
        ...
        protected virtual void UpdateHitObject()
        {
        ...
        protected void SetState(PathPlacementState newState)
        {
            State = newState;
        }

        protected enum PathPlacementState
        {
            Initial,
            Body,
        }
