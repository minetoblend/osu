...
namespace osu.Game.Screens.OnlinePlay.Matchmaking
{
    ...
    {
        private PickScreenPanelGrid selectionGrid = null!;
        ...
        private void load()
        {
            InternalChild = new Container
            {
                ...
                Child = selectionGrid = new PickScreenPanelGrid
                {
                    RelativeSizeAxes = Axes.Both,
                },
            };
        ...
        public void PresentFinalBeatmap(long[] candidateItems, long finalItem) => selectionGrid.PresentFinalBeatmap(candidateItems, finalItem);
    }
}
