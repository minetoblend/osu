...
{
    public partial class TriangleImplosion : CompositeDrawable
    {
        ...
        protected override void LoadComplete()
        {
            ...
            for (int i = 0; i < 15; i++)
            {
                ...
                particle.FadeOut()
                        ...
                        .RotateTo(particle.Rotation + rng.NextSingle() * 360 - 180, duration, Easing.InQuad)
                        .MoveTo(endPosition, duration, Easing.InQuad)
                        .ScaleTo(0.5f + rng.NextSingle(), duration);
            }
