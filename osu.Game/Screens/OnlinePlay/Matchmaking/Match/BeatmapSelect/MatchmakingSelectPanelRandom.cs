...
namespace osu.Game.Screens.OnlinePlay.Matchmaking.Match.BeatmapSelect
{
    public partial class MatchmakingSelectPanelRandom : MatchmakingSelectPanel
    {
        ...
        private BeatmapCardMatchmakingRandomContent content = null!;
        ...
        public override void PresentAsChosenBeatmap(MatchmakingPlaylistItem playlistItem)
        {
            ...
            Scheduler.AddDelayed(() =>
            {
                ...
                {
                    new BeatmapCardMatchmakingBeatmapContent(playlistItem.Beatmap, playlistItem.Mods),
                    flashLayer,
                });
        ...
        {
            if (AllowSelection && content is BeatmapCardMatchmakingRandomContent randomContent)
