            ...
            private void onMatchRoomStateChanged(MatchRoomState? state) => Scheduler.Add(() =>
            {
                ...
                switch (matchmakingState.Stage)
                {
                    ...
                    case MatchmakingStage.ServerBeatmapFinalised:
                        ...
                        ((SubScreenBeatmapSelect)screenStack.CurrentScreen).RollFinalBeatmap(matchmakingState.CandidateItems, matchmakingState.CandidateItem, matchmakingState.CandidateGameplayItem);
                        break;
